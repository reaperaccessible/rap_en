...
reaper.Undo_BeginBlock()
    ...
    local function main();
                ...
                for i2 = Numb, reaper.CountTracks(0) do;-->-2
                    ...
                    if NextTrack then;-->-3
                        ...
                        if VisibTCP then;-->-4
                            ...
                            if Script_Name == "ReaperAccessible - Main - Move selected tracks down one row (if there is a folder, prompt to skip or includes).lua" then; -->-3.21
        ...
        reaper.osara_outputMessage(name .. " moved down")
    end;
