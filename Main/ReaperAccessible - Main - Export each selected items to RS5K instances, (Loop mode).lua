-- @description Export each selected item to an instance of RS5K (Loop mode)
-- @version 1.3
-- @author Ludovic SANSONE for Reaper Accessible
-- @provides [main=main] .


local script_title = "Export each selected items to RS5K instances, (Loop mode)"
...
function ExportSelItemsToRs5k(track, base_pitch)      
  for i = 1, reaper.CountSelectedMediaItems(0) do
    ...
    reaper.TrackFX_SetParamNormalized( track, rs5k_pos, 10, 0.0251 ) -- obey note offs
    reaper.TrackFX_SetParamNormalized( track, rs5k_pos, 11, 1 ) -- obey note offs
    reaper.TrackFX_SetParamNormalized( track, rs5k_pos, 12, 1 ) -- Loop on
