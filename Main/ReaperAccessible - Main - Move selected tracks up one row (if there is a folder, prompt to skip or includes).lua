...
reaper.Undo_BeginBlock()
    ...
    local function main();
                    ...
                    if PreTrack then;-->-2
                        ...
                        if VisibTCP then;-->-5
                            ...
                            ----------------------------------------------
                                ...
                                if Script_Name == "ReaperAccessible - Main - Move selected tracks up one row (if there is a folder, prompt to skip or includes).lua" then;-->-3.21
                                    ...
                                    if not wind then;-->-3.1
                                        ...
                                        if wind then;-->-4.1
                                            ...
                                            local text_w = "Would you like to move this track to the above folder?"
                                             local MB = reaper.MB(text_w, "Moving track up", 4);
        ...
        reaper.osara_outputMessage(name .. " moved up")
    end;
