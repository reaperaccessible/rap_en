...
if not reaper.APIExists( "JS_Window_Find" ) then
  reaper.MB( "Warning, the .dll file (reaper_js_ReaScriptAPI64.dll) is not installed on your system. Please read the KeyMap ReaperAccessible readme carefully for more details. If you have ReaPack installed on your system, press space to start the installation via ReaPack. Otherwise press escape to return to Reaper. Restart Reaper before running the script again. Thanks!", "You must install the reaper_js_ReaScriptAPI64.dll file.", 0 )
