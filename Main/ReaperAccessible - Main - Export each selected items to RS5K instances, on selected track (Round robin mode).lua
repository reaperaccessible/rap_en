...
-- Ajout des fonctions VF_LoadLibraries et VF2_UpdUsedCount
function VF_LoadLibraries()
  -- Cette fonction est maintenant vide car nous n'avons plus besoin de charger les fichiers externes
end
...
function ExportSelItemsToRs5k(track, base_pitch)      
  ...
  for i = 1, reaper.CountSelectedMediaItems(0) do
    ...
    -- Parameters to set round robin up 
    reaper.TrackFX_SetParamNormalized( track, rs5k_pos, 19, 1/(NumberOfItems+1-i) ) -- Probability of hitting 
    reaper.TrackFX_SetParamNormalized( track, rs5k_pos, 20, 1 ) -- Round robin mode on 
    reaper.TrackFX_SetParamNormalized( track, rs5k_pos, 21, 1  ) -- Remove from play list 
...
-- Modification de la partie finale du script
