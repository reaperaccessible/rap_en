-- @description Select all notes with pitch higher than the selected note of selected item
-- @version 1.0
...
function main()
  ...
  if notesChanged then
    ...
    speak(string.format("%d selected MIDI events", selectedCount))
  else
    speak("No notes with higher pitch found")
  end
